...
namespace AccidentalNoise
{
    public sealed class ImplicitClamp : ImplicitModuleBase
    {
        ...
        {            
			return MathUtilities.Clamp(Source.Get(x, y), Low.Get(x, y), High.Get(x, y));
        }

        public override Double Get(Double x, Double y, Double z)
        {
			return MathUtilities.Clamp(Source.Get(x, y, z), Low.Get(x, y, z), High.Get(x, y, z));
        }
        ...
        {
			return MathUtilities.Clamp(Source.Get(x, y, z, w, u, v), Low.Get(x, y, z, w, u, v), High.Get(x, y, z, w, u, v));
        }
    }
}
